	...
	<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item dropdown no-arrow mx-1"><a class="nav-link dropdown-toggle" href="#"
				...
				aria-expanded="false"> <i class="fas fa-bell fa-fw"></i> <!-- Counter - Alerts --> <span
			...
			<li class="nav-item dropdown no-arrow mx-1"><a class="nav-link dropdown-toggle" href="#"
				...
				aria-expanded="false"> <i class="fas fa-envelope fa-fw"></i> <!-- Counter - Messages --> <span
			...
			<li class="nav-item dropdown no-arrow"><a class="nav-link dropdown-toggle" href="#"
				...
				aria-expanded="false"> <span class="mr-2 d-none d-lg-inline text-gray-600 small"
					id="logged-on-user">kosea</span> <img class="img-profile rounded-circle"
